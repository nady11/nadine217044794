...
class StudentformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studentform" do
    assert_difference('Studentform.count') do
      post studentforms_url, params: { studentform: { age: @studentform.age, firstname: @studentform.firstname, lastname: @studentform.lastname } }
    end
  ...
  test "should update studentform" do
    patch studentform_url(@studentform), params: { studentform: { age: @studentform.age, firstname: @studentform.firstname, lastname: @studentform.lastname } }
